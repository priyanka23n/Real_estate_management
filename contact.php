                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Kengeri,Banglore</span> <br>
										<span class="text-white">Kengeri,Banglore</span>
										</div>
                                </li>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white">prs@realestatest.com</span>
										<span class="text-white">prs@realestatest.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
